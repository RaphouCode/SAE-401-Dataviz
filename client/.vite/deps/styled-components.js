...
function Te(e) {
	...
	p.push(function(e) {
		e.type === "rule" && e.value.includes("&") && (o || (o = new RegExp("\\".concat(n, "\\b"), "g")), e.props[0] = e.props[0].replace(Pe, n).replace(o, l));
...
function nt(e, s, i) {
	...
	function E(e, s) {
		return function(e, s, i) {
			...
			for (var w in v) void 0 === v[w] || "$" === w[0] || "as" === w || "theme" === w && v.theme === y || ("forwardedAs" === w ? S.as = v.forwardedAs : m && !m(w, g) || (S[w] = v[w], m || isPropValid(w) || tt.has(w) || !D.has(g) || (tt.add(w), console.warn("styled-components: it looks like an unknown prop \"".concat(w, "\" is being sent through to the DOM, which will likely trigger a React console error. If you would like automatic filtering of unknown props, you can opt-into that behavior via `<StyleSheetManager shouldForwardProp={...}>` (connect an API like `@emotion/is-prop-valid`) or consider using transient props (`$` prefix for automatic filtering.)")))));
			var N = function(e, t) {
